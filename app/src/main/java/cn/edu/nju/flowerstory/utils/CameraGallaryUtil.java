...
public class CameraGallaryUtil {
    ...
    public static Bitmap getBitmapFromCG(Fragment activity, int requestCode, int resultCode, Intent data) {
        Bitmap bitmap = null;
        switch (requestCode) {
    ...
    private static void startPhotoZoom(Fragment activity, Uri uri) {
